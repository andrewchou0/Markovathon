  ...
  return (
    <section className="network-section panel" id="supplier-network" aria-labelledby="suppliers-title">
      <div className="section-heading">
        <div><h2 id="suppliers-title">Supplier network <span className="count-badge">{suppliers.length}</span></h2><p>Select a supplier to inspect its dependencies.</p></div>
      ...
      <div className="supplier-grid">
        ...
        {!shown.length && <div className="empty-filter"><Icon name="shield" size={24} /><h3>No exposed suppliers yet</h3><p>Run a demo event to see which suppliers are affected.</p><button className="text-button" onClick={() => onFilter('all')}>Show all suppliers</button></div>}
      </div>
